...
- The thing you want to build today will select three random photos and display them side-by-side-by-side in the browser window.
- In addition, you'll want to be able to receive clicks on those displayed images, and tally those clicks for each image. You'll also want to tally how many times each image is displayed, for statistical purposes.
- Upon receiving a click, three new non-duplicating random images should be displayed in place of the old ones. In other words, the three images that are displayed should contain no duplicates among themselves, nor should they duplicate with any images that we displayed immediately before.
...
**This is an individual assignment today, but you are free (heck, even encouraged) to collaborate with classmates if you want. Just be sure that if you do, be sure to make note of any shared code that results from that collaboration in your README file.**
